    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="text-lg font-bold text-blue-700 mb-6 text-center">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              onClick={() => onSave({ ...initialUser, phone_number: phone, password })}
...
function UserPage() {
  ...
  const handleDeleteUser = async () => {
    try {
      const token = localStorage.getItem('adminToken');
      await axios.delete(
        `${import.meta.env.VITE_API_BASE_URL}/delete-admin/${deleteUser.id}`,
        { headers: { 'Authorization': `Bearer ${token}` } }
      );
      setDeleteOpen(false);
      setDeleteUser(null);
